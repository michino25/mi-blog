...
export default function EditPost() {
    ...
    return (
        <form className="my-10 mx-48" onSubmit={updatePost}>
            ...
            <div>
                ...
                <div className="relative w-full py-4 pl-24 pr-10 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <span className="inline-block text-sm text-gray-900 dark:text-white">
                        {file.name ? file.name : getImageName(title)}
                    </span>

                    <button
                        type="button"
                        className="relative font-normal rounded-full text-sm ml-3 px-4 py-1 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-0 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600"
